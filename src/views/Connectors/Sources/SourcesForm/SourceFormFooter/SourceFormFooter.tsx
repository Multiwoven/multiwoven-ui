...
const SourceFormFooter = ({
  ...
  documentationLink = "https://docs.multiwoven.com/get-started/introduction",
        ...
        <Box display="flex" paddingX="16px" paddingY="10px">
          {isDocumentsSectionRequired ? (
            <>
              ...
              <Link to="https://join.slack.com/t/multiwoven/shared_invite/zt-2bnjye26u-~lu_FFOMLpChOYxvovep7g">
